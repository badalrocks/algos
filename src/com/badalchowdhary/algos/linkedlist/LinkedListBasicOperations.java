...
public class LinkedListBasicOperations
{
    public static void main(String[] args)
    {
        ...
        System.out.println("after adding 1,2,3,4: " + ll.getLinkedListNodes());

        ll.delete(new Node(2));
        System.out.println("after deleting 2: " + ll.getLinkedListNodes());

        ll.delete(new Node(1));
        System.out.println("after deleting 1: " + ll.getLinkedListNodes());

        System.out.println("node count: " + ll.getNodeCount());

        ll.delete(new Node(3));
        System.out.println("after deleting 3: " + ll.getLinkedListNodes());

        System.out.println("node count: " + ll.getNodeCount());

        ll.delete(new Node(4));
        System.out.println("after deleting 4: " + ll.getLinkedListNodes());
        System.out.println("node count: " + ll.getNodeCount());
